...
// ─── Architektur ──────────────────────────────────────────────────────────────
//
// Teil von Apis (ersetzt ConditionalSellOrder — siehe Chat: "eigener Vault pro
// Plan" statt eines geteilten Contracts). Ein TriggerVault ist ein
// EIP-1167-Clone (identisches Muster wie DcaVault) für GENAU EINEN Plan:
// hält bei setupPlan() einen festen Betrag eines Tokens in Verwahrung (echter
// Transfer, kein bloßes Allowance-Pull-Modell wie bei ConditionalSellOrder),
// wartet auf eine vom Apis-Keeper beobachtete Preisbedingung, tauscht bei
// Auslösung den KOMPLETTEN verwahrten Betrag einmalig und sendet das Ergebnis
// an den Owner. Funktioniert für beide Richtungen — "Buy Plan" (heldToken=
// Stablecoin, outputToken=Zieltoken) und "Sell Plan" (heldToken=Zieltoken,
