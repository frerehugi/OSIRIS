...
// Celo-Builders-Attribution: eine Zeile, wiederverwendet an jedem
// writeContractAsync-Call unten. Siehe ATTRIBUTION_TAG in src/config.ts für
// den Hintergrund (Hackathon-Registrierung, warum das hier rein muss).
